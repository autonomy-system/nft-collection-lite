...
const defaultIPFSPrefix = "https://ipfs.io";
const cloudflareIPFSPrexix = "https://cloudflare-ipfs.com";

String _replaceIPFS(String url) {
  if (url.startsWith(defaultIPFSPrefix)) {
    return url.replaceRange(0, defaultIPFSPrefix.length, cloudflareIPFSPrexix);
  }
  return url;
}
